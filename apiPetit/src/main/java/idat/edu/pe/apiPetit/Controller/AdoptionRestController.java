...
public class AdoptionRestController {
    ...
    @RequestMapping(path = "/user/{userId}/{stateId}/{petId}/createAdoption", method = RequestMethod.POST)
    ...
    @RequestMapping(path = "/user/{userId}/listAdoptions", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/user/{userId}/listAdoptions/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/user/{userId}/listAdoptions/{id}", method = RequestMethod.PUT)
    ...
    @RequestMapping(path = "/user/{userId}/listAdoptions/{id}", method = RequestMethod.DELETE)
