...
public class AccountRestController {
    ...
    @RequestMapping(path = "/user/{userId}/createAccount", method = RequestMethod.POST)
    public ResponseEntity<AccountDTO> saveAccount(@PathVariable(name = "userId") Integer userId, @RequestBody AccountDTO accountDTO){
        return new ResponseEntity<>(accountService.createAccount(userId, accountDTO), HttpStatus.CREATED);
    }

    @RequestMapping(path = "/user/{userId}/listAccounts", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/user/{userId}/listAccounts/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(path = "/user/{userId}/listAccounts/{id}", method = RequestMethod.PUT)
    ...
    @RequestMapping(path = "/user/{userId}/listAccounts/{id}", method = RequestMethod.DELETE)
